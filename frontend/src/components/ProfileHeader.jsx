      ...
      case "connected": 
        return (
          <div className="flex gap-2 justify-center">
            ...
            <button className={`${baseClass} bg-red-500 hover:bg-red-600 text-sm`} onClick={() => removeConnection(userData._id)}>
    ...
    <div className="bg-white rounded-lg shadow mb-6">
      ...
      <div className="p-4">
        <div className="relative -mt-20 mb-4">
          ...
          {isEditing &&(
            <label className="absolute bottom-0 right-1/2 transform translate-x-16 bg-white rounded-full p-2 cursor-pointer shadow">
                <Camera size={20} />
                <input
                  type="file"
                  className="hidden"
        ...
        <div className="text-center mb-4">
          {isEditing ? (
            <input
              type="text"
              className="w-full text-2xl text-center mb-2 font-bold"
        ...
        {isOwnProfile ? (
          isEditing ? (
            <button 
              className="bg-primary w-full hover:bg-primary-dark text-white py-2 px-4 rounded-full transition duration-300"
              onClick={handleSave}>
              Save Profile
            </button>
          ): (
