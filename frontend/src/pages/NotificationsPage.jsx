...
const NotificationsPage = () => {
    ...
    const renderRelatedPost = (relatedPost) =>{
        ...
        return (
            ...
            >
                {relatedPost.image && (
                    <img src={relatedPost.image} alt="Post preview" className="w-10 h-10 rounded object-cover"/>
                )}
                                     ...
                                     <div className="flex gap-2">
                                        {!notification.read && (
                                            <button
                                                ...
                                                className="p-1 bg-blue-100 rounded text-blue-600 hover:text-blue-200 transition-colors"
                                        ...
                                        <button
                                            ...
                                            className="p-1 bg-red-100 rounded text-red-600 hover:text-red-200 transition-colors"
